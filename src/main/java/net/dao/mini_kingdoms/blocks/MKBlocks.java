...
public class MKBlocks {
    ...
    public static final RegistryObject<Block> FURNITURE_STORE = BLOCKS.register("standard_furniture_store",
            () -> new Block(BlockBehaviour.Properties.of().strength(2f).sound(SoundType.METAL))); //This is a block item, this block makes nothing, just for internal function
    ...
    public static final RegistryObject<Block> LOG_YARD = BLOCKS.register("standard_log_yard",
            () -> new Block(BlockBehaviour.Properties.of().strength(2f).sound(SoundType.METAL))); //This is a block item, this gives logs and sticks
